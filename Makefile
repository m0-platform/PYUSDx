...
# Deployment helpers
deploy-local :; FOUNDRY_PROFILE=production forge script script/deploy/DeployAll.s.sol --rpc-url localhost --broadcast -v
deploy-sepolia :; FOUNDRY_PROFILE=production forge script script/deploy/DeployAll.s.sol --rpc-url sepolia --broadcast -vvv
